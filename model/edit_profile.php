<?php 
    ...
    if($_POST['type']=='change_avatar'){
        $avatar_seed = $_POST['avatar_seed'];
        $user_id = $_SESSION['user_id'];
        $_SESSION['avatar_seed'] = $avatar_seed;

        $sql = mysqli_query($conn,"UPDATE users SET avatar_seed=$avatar_seed WHERE user_id=$user_id") or die(mysqli_error($conn));
